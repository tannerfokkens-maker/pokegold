...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, FOCUS_ENERGY, KARATE_CHOP, FURY_SWIPES
...
ClairGroup:
	...
	db 40, KINGDRA,    SAND_ATTACK, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, QUILAVA,    LEER, SAND_ATTACK, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, CROCONAW,   LEER, FOCUS_ENERGY, WATER_GUN, BITE
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, QUILAVA,    SAND_ATTACK, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FERALIGATR, FOCUS_ENERGY, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, TYPHLOSION, SAND_ATTACK, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, FERALIGATR, FOCUS_ENERGY, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 26, CHARMANDER, EMBER, SAND_ATTACK, FOCUS_ENERGY, SCARY_FACE
	...
	db 34, KINGLER,    WATER_GUNBEAM, STOMP, GUILLOTINE, PROTECT
	...
	db 38, KINGLER,    WATER_GUNBEAM, STOMP, GUILLOTINE, PROTECT
	...
	db 32, KINGLER,    WATER_GUNBEAM, STOMP, GUILLOTINE, PROTECT
	...
	db 27, CHARMELEON, EMBER, SAND_ATTACK, FOCUS_ENERGY, SCARY_FACE
	db -1 ; end
...
FisherGroup:
	...
	db 25, REMORAID,   LOCK_ON, PSYBEAM, AURORA_BEAM, WATER_GUNBEAM
	db 25, REMORAID,   LOCK_ON, PSYBEAM, AURORA_BEAM, WATER_GUNBEAM
	db -1 ; end
...
SwimmerFGroup:
	...
	db 21, HORSEA,     WATER_GUN, SAND_ATTACK, LEER, WATER_GUN
	db 21, HORSEA,     DRAGON_RAGE, SAND_ATTACK, LEER, WATER_GUN
	db -1 ; end
...
SailorGroup:
	...
	db 18, KRABBY,     WATER_GUN, LEER, VICEGRIP, HARDEN
	db 20, KRABBY,     WATER_GUNBEAM, LEER, VICEGRIP, HARDEN
	db -1 ; end
...
Rival2Group:
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, TYPHLOSION, SAND_ATTACK, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, FERALIGATR, FOCUS_ENERGY, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, TYPHLOSION, SAND_ATTACK, QUICK_ATTACK, FIRE_BLAST, SWIFT
	db -1 ; end
...
BurglarGroup:
	...
	db 24, KOFFING,    TACKLE, SMOG, SLUDGE, SAND_ATTACK
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 33, KOFFING,    TACKLE, SLUDGE, SAND_ATTACK, HAZE
	...
	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, SAND_ATTACK
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, SAND_ATTACK
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, SAND_ATTACK
	db 32, WEEZING,    TACKLE, EXPLOSION, SLUDGE, SAND_ATTACK
	db 30, KOFFING,    TACKLE, SELFDESTRUCT, SLUDGE, SAND_ATTACK
	db 30, KOFFING,    TACKLE, SMOG, SLUDGE, SAND_ATTACK
	db -1 ; end
